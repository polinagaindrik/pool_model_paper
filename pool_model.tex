...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/abm_ode_comparison.png}
    \caption{
        Comparison of the \ac{abm} and \ac{ode} output corresponding to the parameters presented in table~\ref{tab:spatial_limit_init}.
        % TODO
    }
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l *5{>{\centering\arraybackslash}X}@{}}
        ...
        & Production                & $b$           & $0.1$\unit{\per\minute}\\
        ...
        & Nutrients                 & $A$           & $1.0$\unit{\mol\per\micro\metre\cubed}\\
