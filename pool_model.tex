...
The previously considered \ac{ode} formulation makes extensive use of the assumption that the
bacteria are evenly distributed and all communications and interactions between bacteria or
nutrients occurr on time scales much faster than the remaining processes.
However, for heterogenous systems or nutrients with low diffusability, this assumption might not be
valid.\\
