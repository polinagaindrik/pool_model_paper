...
\begin{figure}[H]
    ...
    \caption{{
        \footnotesize The two species system competing for the common nutritient $R$ with production of the toxin $T$ (brown line) calculated using Eq. (\ref{eq:model_2sp_toxin}).
