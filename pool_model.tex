...
Further we show that the TPM can be readily extended to the systems with more than one bacteria and describe more complex relationships between species. 
%
%
%
% ------------------------------------------------------------------------------------------------
\subsection{Resource Competition}
One on the ways to describe competition between bacteria populations is as a function of limiting resources ratio~\cite{tilman_resource_1977, smith_effects_2002}.
...
\end{eqnarray*}
which has the structure of a \ac{glv}.
...
In food studies the \ac{glv} was applied by Mounier \etal~\cite{mounier_microbial_2008} to study interactions of six bacteria species  with yeast omissin in cheese.
...
\cmt{\cite{lenski_coexistence_1986}: Modeling of the 2 sp. system with 1resource and 1 inhibitor.}
