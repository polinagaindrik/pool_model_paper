...
\usepackage[a4paper,inner=2.5cm,outer=3cm]{geometry}
...
\begin{figure}[t]
    \begin{center}
    \includegraphics[width=\columnwidth]{Figures/TPM_fig.pdf}
...
\begin{figure}[h]
    \begin{center}
    \includegraphics[width=\columnwidth]{Figures/pool_model_3pools_resource.pdf}
    \caption{
...
\begin{figure}[t]
    \begin{center}
    \includegraphics[width=\columnwidth]{Figures/pool_model_3pools_resource_tempshift.pdf}
    \caption{
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=\columnwidth]{Figures/pool_model_2pools_resource_competition.pdf}
    \caption{
...
\begin{figure}[H]
    \begin{center}
    % TODO make this into 2x2 grid for plots and insert eqnarray from before as well
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=\columnwidth]{Figures/pool_model_2sp_1pool_coop.pdf}
    \caption{
...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.5\columnwidth}
        ...
        \subcaption{Homogenous initial cell distribution, $D=30.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\columnwidth}
        \includegraphics[width=\columnwidth]{Figures/abm-homogenous-low-diffusion/abm_ode_comparison.png}
        \subcaption{Homogenous initial cell distribution, $D=5.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}\\
    \begin{subfigure}[c]{0.5\columnwidth}
        \includegraphics[width=\columnwidth]{Figures/abm-inhomogenous/abm_ode_comparison.png}%
        \subcaption{Heterogeneous initial cell distribution, $D=30.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\columnwidth}
        \includegraphics[width=\columnwidth]{Figures/abm-random/abm_ode_comparison.png}%
        \subcaption{Randomized initial cell distribution, $D=5.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}
    \caption{
