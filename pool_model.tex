...
According to the growth curves (\cmt{some references on bacteria growth curves??}) quite often at the beginning no increase in bacterial count is present and so-called lag-phase is observed.
...
\cmt{Ref about Quorum sensing. Signalling mechanism that controll gene expression (bacteria growth within species) in response to environment. }
...
One on the ways to descibe competition between bacteria populations is as a function of limiting resources ratio. \cmt{Ref Tilman 1977, Ref Smith 2002}
