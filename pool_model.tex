...
%
% ................................................................................................
\subsubsection{Physical Mechanics}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l *5{>{\centering\arraybackslash}X}@{}}
        ...
        \cmidrule[1pt](l{\tabcolsep}r{\tabcolsep}){1-3}
        \cmidrule[1pt](l{\tabcolsep}r{\tabcolsep}){4-6}
         & \textbf{Symbol} & \textbf{Value} && \textbf{Symbol} & \textbf{Value}\\
        \toprule
        Rate $L_A\rightarrow G_A$   & $\lambda_A$   & $0.001$\unit{\per\minute}
        &                           & $\lambda_A$   & $0.001$\unit{\per\minute}\\
        Rate $L_B\rightarrow G_B$   & $\lambda_B$   & $0.0005$\unit{\per\minute}
        &                           & $\lambda_B$   & $0.0005$\unit{\per\minute}\\
        Production $G_A$            & $\alpha_A$    & ??\unit{\per\minute}
        & Uptake                    & $u_A$         & $0.01$\unit{\per\minute}\\
        Production $G_B$            & $\alpha_B$    & ??\unit{\per\minute}
        & Uptake                    & $u_B$         & $0.01$\unit{\per\minute}\\
        Production $I$              & $\kappa$      & $1.18\cdot10^{-5}$\unit{\per\minute}
        &&&\\
        Inhibition         & $\mu_I$       & $1.11\cdot 10^{-6}$\unit{\per\micro\metre\cubed}
        &&&\\
        Total volume     & $N_t$         & $1.80\cdot 10^4$\unit{\micro\metre\cubed}
        &&&\\
        \textbf{Initial Values}\\
        \toprule
        Volume of $L_A$             & $L_A$         & $35.34$\unit{\micro\metre\cubed}
        & Cell Number               & $C_A$         & 5\\
        Volume of $G_A$             & $G_A$         & $0.0$\unit{\micro\metre\cubed}
        &                           &               & 0\\
        Volume of $L_B$             & $L_B$         & $28.27$\unit{\micro\metre\cubed}
        & Cell Number               & $C_B$         & 4\\
        Volume of $G_B$             & $G_B$         & $0.0$\unit{\micro\metre\cubed}
        &                           &               & 0\\
        Relative nutrients          & $R$           & $1.0$
        & Nutrients                 & $A$           & 2.0\unit{\mol\per\micro\metre\cubed}\\
        Volume inhibitor            & $I$           & $0.0$\unit{\micro\metre\cubed}
        & Inhibitor                 &               & $0.0$\unit{\mol\per\micro\metre\cubed}\\
        \bottomrule
    \end{tabularx}
