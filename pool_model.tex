...
Moreover, the species 1 is able to release a certain antimicrobial component $I$ that shows inhibitory effect on species 2.
...
\begin{equation}
    \begin{cases}
        \dot{R} = -\frac{\alpha_1}{N_t} R G_1-\frac{\alpha_2}{N_t} R G_2 \\
        \dot{I} = \kappa G_1
    \end{cases}.
