...
As described above, the proposed model operates with the total number of the bacterial counts for different species and states in the system not accounting for their spatial distributions.
Assuming that the bacterial system is uniformly distributed (sometimes also called 'well-stirred') we can simplify the problem to a system of \acp{ode}.
However, in reality spatial effects can play a significant role for population survival forcing some species develop competitive mechanisms such as cell adhesion to surfaces in the areas rich with nutritients~\cite{htuson_bacteriasurface_2013}.
...
These effects can only be treated with a spatial model that is able to describe the observed effects.\\
%
%
...
It has to be noted that the resource pool is normalized by its initial value, ie $R^* = R/R_0$.
Moreover, the species $A$ is able to release a certain antimicrobial component $I$ that shows inhibitory effect on species 2 (amensalism).
We assume that $L,G$ are measured in terms of overall volume and $R,I$ are measured as total amount.
...
We use \texttt{cellular\_raza}~\cite{Pleyer_cellular_raza_2023} to implement an \ac{abm}.
...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.5\textwidth}
        ...
        \subcaption{Inhomogenous initial cell distribution, $D_R=D_I=30.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\textwidth}
        \includegraphics[width=\textwidth]{Figures/abm-inhomogenous-low-diffusion/abm_ode_comparison.png}%
        \subcaption{Inhomogenous initial cell distribution, $D_R=D_I=5.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}
    \caption{
        ...
        In subfigure (d), due to the heterogenous cell distribution (see also~\ref{fig:supplement-spatial-initial-config-cells}) and slow diffusion, overall inhibition of species $B$ does not play as large of a role.
...
\begin{table}[H]
    ...
    \caption{
        ...
        Specifying all parameters here would requrie a much larger table.
        For the full information, we refer to the supplementary material~\ref{sec:supplement-full-parameters}.
    }
...
\subsection{Deriving the Pool Model}
...
%
% ................................................................................................
\subsection{Full List of Parameters}
...
%
% ................................................................................................
\subsection{Homogenous and Inhomogenous Initial Cell Distributions}
...
\begin{figure}
    ...
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\textwidth}
        \includegraphics[width=\textwidth]{Figures/abm-inhomogenous-low-diffusion/snapshot_00012000.png}%
        \subcaption{Inhomogenous initial cell distribution, $D_R=D_I=5.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}
    \caption{
