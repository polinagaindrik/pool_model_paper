...
Therefore, we obtain the relations $\frac{u}{1+\nu_I I}R_e = aR_{i,cB}$ and $u R_e=a R_{i,c_A}$ which we can use to eliminate the variable monitoring internal resource concentrations $R_{i,c}$.
...
\begin{alignat}{5}
    ...
    \dot{R} &=& u \sum\limits_{c_A}\frac{V_{c_A}}{V_D} &R \delta(x-x_{c_A})\\
        &&-\frac{u}{1+\nu_I I} \sum\limits_{c_B}\frac{V_{c_B}}{V_D} &R \delta(x-x_{c_B}) &+& D_R \Delta R\nonumber\\
    \dot{I} &=& \sum\limits_{c_A} b&\frac{V_{c_A}}{V_D}\delta(x-x_c) &+& D_I\Delta I
