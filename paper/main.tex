...
\begin{figure}[H]
    ...
    \begin{subfigure}[c]{0.5\textwidth}
        ...
        \subcaption{Homogeneous initial cell distribution, $D_R=D_I=30.0$~\unit{\micro\metre\squared\per\second}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\textwidth}
    ...
    \begin{subfigure}[c]{0.5\textwidth}
        ...
        \subcaption{Heterogeneous initial cell distribution, $D_R=D_I=30.0$~\unit{\micro\metre\squared\per\second}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\textwidth}
        \includegraphics[width=\textwidth]{Figures-abm-random-images-snapshot_00024000.pdf}%
        \subcaption{Random initial cell distribution, $D_R=D_I=30.0$~\unit{\micro\metre\squared\per\second}}
    \end{subfigure}
    \caption{
