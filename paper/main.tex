...
\begin{figure}
    ...
    \end{tikzonimage}%
    \caption{
        Simulation snapshots at $1.04$~\unit{\day}, $\SI{100}{\minute},\SI{200}{\minute},\SI{300}{\minute}$ and $\SI{400}{\minute}$
...
The chosen diffusion constants $D_I=D_R=\SI{20}{\micro\metre\squared\per\second},\SI{5}{\micro\metre\squared\per\second}$ mimick a behavior of a fast and slowly diffusing system respectively.
\begin{figure*}
    \centering
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l *2{>{\centering\arraybackslash}X} l *2{>{\centering\arraybackslash}X}@{}}
        ...
        &&&\\
        &&
        & Diffusion $R$             & $D_R$         & $30.0$~\unit{\micro\metre\squared\per\second}\\
        &&
        & Diffusion $I$             & $D_I$         & $30.0$~\unit{\micro\metre\squared\per\second}\\
