...
\begin{align}
    \begin{split}
        ...
        \dot{G}_A &= \lambda_A R L_A + \alpha_A R G_A\\
        \dot{L}_B &= -\lambda_B R L_B\\
        \dot{G}_B &= \lambda_B R L_B + \frac{\alpha_B}{1 + K_I I} R G_B.
    \end{split}
...
\begin{align}
    \begin{split}
        \dot{R} &= -\frac{\alpha_A}{N_t} R G_A-\frac{\alpha_B}{(1 + K_I I) N_t} R G_B \\
        \dot{I} &= \kappa G_A.
    \end{split}
...
\begin{align}
    ...
    \dot{G}_B &= \frac{\alpha_B}{1 + K_I I} R G_B + \lambda_B R L_B\\
    \dot{R} &= -\frac{\alpha_A}{N_t} R G_A-\frac{\alpha_B}{(1 + K_I I) N_t} R G_B\\
    \dot{I} &= \kappa G_A
\end{align}
