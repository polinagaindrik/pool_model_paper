...
\documentclass[10pt,twocolumn,5p,authoryear]{elsarticle/elsarticle}
...
This so-called preparation before the exponential growth includes synthesis of the needed compounds, initiation of the transcription~\citep{rolfe_lag_2012} and poorly studied physiological and regulatory mechanisms~\citep{monod_growth_1949}.
...
And after "difficult times" bacteria, also called viable but non-culturable (VBNC), can continue cell division~\citep{kell_viability_1998}.
