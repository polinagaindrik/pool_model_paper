...
\begin{figure}
    ...
    \caption{
        ...
        All curves were calculated using the model (\ref{eq:ode_3pool_resource2}) with parameters $\mu=2.5~\mathrm{h}^{-1}$, $\omega=0~\mathrm{h}^{-1}$, $N_t = 10^4$.
...
After the extreme conditions are overcome the bacteria returns to a normal exponential growth with the rate $\xi$.
%
%
...
There we can see the asymmetric behavior of the rate $\gamma$ depending on the direction of the temperature change.
...
In case of increase of the temperature the transition into the dormant state is much less so the effect is not noticeable while on the other hand the division of bacteria is stimulated by more preferable conditions.
%
% ================================================================================================
