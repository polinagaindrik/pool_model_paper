...
The natural bacetrial processes are a crucial part of our planets ecosystem, being responsible for
...
all relevant biologial phenomena arising in these bacterial systems.
During their reproductive process, bacteria undergo multiple phases, starting in a lag phase which
is necessary to adapt to new environments and initially impedes the overall growth.
Additionally, bacteria are able to cooperate e.g. via complementary metabolic processes or inhibit
each other e.g. by means of waste production as a metabilic byproduct.
A limited supply of nutrients will also affect the overall reproductive capacity of the colony.
Bacteria have thus devised various survival strategies to ensure a sufficient access to nutrients.
Effects on a single-cell level such as adhesion, migration and chemotaxis can lead to complex
...
biofilm formation which play an important role for many mature microbial community.
...
Various \acp{ode} \textit{primary models} describe the bacterial growth curve under contant
...
The advantage of the \ac{ode} formulation lies in the predictive power and simplicitiy of usage.
...
Our model also allows us to capture interactions between these bacterials states and the external
microenvironment.
...
We analyze the spacial limitations of an interacting two-species model and show that it can be fully
understood on an individual-based level in terms of single-cell processes.
Furthermore, we asses how spatial heterogeneity can impact the shape of the growth curves.
