...
\documentclass[10pt,twocolumn,5p]{elsarticle}
...
\begin{abstract}
    ...
    interspecies cooperation or competition.
    ...
    We further apply this \ac{abm} to study the role of spatial effects on the dynamics of bacterial
    growth.
\end{abstract}
...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.5\textwidth}
        \includegraphics[width=\textwidth]{Figures-abm-homogeneous-images-snapshot_00012000.png}
        \subcaption{Homogeneous initial cell distribution, $D_R=D_I=30.0$\unit{\micro\metre\squared\per\minute}}
    \end{subfigure}%
    \begin{subfigure}[c]{0.5\textwidth}
        \includegraphics[width=\textwidth]{Figures-abm-homogeneous-low-diffusion-images-snapshot_00012000.png}
